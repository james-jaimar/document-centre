...
import { useDocumentUpload, recoverThumbnailGaps, reconcileStuckDocument } from "@/hooks/useDocumentUpload";
...
import { resize, rotate, pollJob, cropRasterize, getAsset, getDerivedFiles, ensureFreshAsset, inspectAsset, normalizeOrientation, printReady, prepareForProduct } from "@/lib/documentCentreApi";
...
export default function OrderFiles() {
  ...
  const [posterEditorInitialState, setPosterEditorInitialState] = useState<
    import("@/components/order/PosterImageEditor").PosterEditorInitialState | undefined
  >(undefined);
  const [posterEditorTitle, setPosterEditorTitle] = useState<string | undefined>(undefined);
