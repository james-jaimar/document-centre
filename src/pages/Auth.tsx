...
import { AlertCircle, Printer, Info, ArrowLeft } from "lucide-react";
...
const Auth = () => {
  ...
  const logoUrl = (isTenantPortal ? branding?.logo_url?.trim() : "") || brandedTenant?.logo_url || "";
