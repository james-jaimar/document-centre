...
import { useAdminQuote, useAdminUpdateQuoteStatus } from "@/hooks/useAdminQuotes";
import { useSendQuoteEmail } from "@/hooks/useQuotes";
...
import { ArrowLeft, Mail, XCircle, Loader2 } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between flex-wrap gap-4">
        ...
        <div className="flex gap-2">
          <Button variant="outline" onClick={handleSend} disabled={sendEmail.isPending}>
            {sendEmail.isPending
          ...
          {status === "active" && (
            <Button variant="outline" onClick={handleDecline} disabled={updateStatus.isPending}>
