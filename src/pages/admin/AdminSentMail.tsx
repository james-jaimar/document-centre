...
export default function AdminSentMail() {
  ...
  useEffect(() => { load(); }, [tenantId, statusFilter, categoryFilter]);
    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Outgoing email queue and history for your tenant.</p>
        </div>
