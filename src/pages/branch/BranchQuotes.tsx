...
export default function BranchQuotes() {
  const { data, isLoading } = useBranchQuotes();
    ...
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 space-y-3">
          ...
          <p className="text-muted-foreground">No quotes for this branch yet.</p>
        </div>
      ) : (
        <Table>
          <TableHeader>
