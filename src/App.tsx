  ...
  return (
    <Routes>
      ...
      <Route element={<ProtectedRoute allowedRoles={[...branchRoles]} allowedMembershipRoles={["branch_manager", "store_operator", "owner", "admin"]}><BranchLayout /></ProtectedRoute>}>
        ...
        <Route path="/branch/pricing" element={<Navigate to="/branch/catalog-pricing" replace />} />
        <Route path="/branch/rate-card" element={<Navigate to="/branch/catalog-pricing" replace />} />
